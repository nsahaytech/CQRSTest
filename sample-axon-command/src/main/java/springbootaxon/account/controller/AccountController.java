...
public class AccountController {
	...
	@PostMapping(path = "/{accountHolderId}")
	public CompletableFuture<String> createAccount(@RequestBody AccountOwner user, @PathVariable String accountHolderId) {
		String id = UUID.randomUUID().toString();
		return commandGateway.send(new AccountCreateCommand(id, accountHolderId, user.getName()));
	}
